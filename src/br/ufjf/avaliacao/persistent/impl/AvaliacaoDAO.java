...
public class AvaliacaoDAO extends GenericoDAO implements IAvalicaoDAO {
	...
	//verifica se um professor ja foi avaliado por esse questionario para avaliar mais de um professor por turma
		...
		public List<Avaliacao> avaliacoesTodasTurmas(String semestre, Curso curso) {//usado no resultadoControler para pegar avalia�oes filtradas
		...
		public List<Avaliacao> retornaAvaliacoesUsuarioTurmaSemestre(Usuario usuario,Turma turma, String semestre){ // carraga avalia�oes de uma turma e um professor em um semestre
			try {
				Query query = getSession() 
						.createQuery(
...
//						a.remove(i);
		...
		public List<Avaliacao> retornaAvaliacoesPrazoAvaliado(PrazoQuestionario prazo, Usuario avaliado){ // dado um prazo, ele retorna a as avalia�oes daquele prazo
			try {
				Query query = getSession()
						.createQuery(
		...
		public List<Avaliacao> getAvaliacoesPrazoQuestionario(PrazoQuestionario prazo){ // dado um prazo, ele retorna a as avalia�oes daquele prazo
			try {
				Query query = getSession()
						.createQuery(
